...
class ProviderController extends Controller {
    ...
    public function index( Request $request ) { 
        ...
        $providers = new MtProvider; 

        if ( !$request->order_by ) {
            $providers = $providers->orderBy('id', 'DESC');  
        } 

        $providers = $providers->with('logo_small_src', 'logo_big_src', 'categories');
        ...
        $providercats = MtTaxonomy::lists('provider-category');

        return compact('providers', 'providercats');
    } 
