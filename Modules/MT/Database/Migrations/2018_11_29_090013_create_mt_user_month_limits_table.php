...
class CreateMTUserMonthLimitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mt_user_month_limits', function (Blueprint $table) {
            $table->increments('id');    
    ...
    {
        Schema::dropIfExists('mt_user_month_limits');
    }
}
