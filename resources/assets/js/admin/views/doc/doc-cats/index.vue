        ...
        <div class="component-body">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{ (formType) ? 'New' : 'Update' }} Document Category</h5>
                            ...
                            <div class="modal-body"> 
                                ...
                                <div class="form-row"> 
                                    ...
                                    <div class="col-12 mb-3"  v-if="allTaxonomies.length">
                                        <label for="parent_id" class="o-s-l">Parent Document Category</label> 
            ...
            <div class="table-actions">
                <button v-can="'provider-taxonomy-create'" type="button" @click="newForm()" class="btn btn-sm bg-success" data-toggle="modal" data-target="#createModal">
                    <i class="icon-plus-squared"></i> Document Category
                </button> 
...
export default {
    ...
    methods: {  
        ...
        getLists( page = 1, click = false ) {
            ...
            axios.get('/api/v1/doc/taxonomies/doc-category?'+ queryString)
                .then(function (resp) {
                    app.preloader = false;
        ...
        saveForm() { 
            ...
            if ( this.formType ) {
                axios.post('/api/v1/doc/taxonomies', newTaxonomy)
                    .then( resp => {  
                        this.taxonomy = this.taxonomyConst;
                ...
                axios.patch('/api/v1/doc/taxonomies/' + newTaxonomy.id, newTaxonomy)
                    .then( resp => { 
        ...
        deleteEntry(id, index) {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                axios.delete('/api/v1/doc/taxonomies/' + id)
                    .then(function (resp) {
        ...
        deleteSelected() { 
            ...
            if (confirm(app.$store.state.confirmDel)) {
                ...
                axios.delete('/api/v1/doc/taxonomies/' + selectedItem)
                    .then(function (resp) {
