                        ...
                        <form v-on:submit.prevent="saveForm()">
                            <div class="modal-body"> 
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-12 mb-3 outline-group" v-if="provider.type == 1 ">
                                        <input placeholder=" " type="text" class="form-control outline" id="prefix" v-model="provider.prefix">
                                        <label for="prefix">Prefix</label>
                                    </div><!--  /.col-md-4 mb-3 -->

                                    <div class="col-12 mb-3 outline-group" v-if="provider.type == 1 ">
                                        <input placeholder=" " type="number" class="form-control outline" id="length" v-model="provider.length">
                                        <label for="length">Length</label>
                                    </div><!--  /.col-md-4 mb-3 -->

                                    <div class="col-12 mb-4">
                                        <label class="o-s-l">Type</label>
                                        <select class="form-control" v-model="provider.type">
                ...
                <table class="table table-striped bg-white">
                    ...
                    <tbody> 
                        ...
                        <tr v-for="provider, index in providers.data"> 
                            ...
                            <td class="taxonomies">
                                <template v-if="provider.type == 1">
                                    Telecom
                                </template> 
                                <template v-else-if="provider.type == 2">
                                    Social
                                </template>
                            </td> 
                            <td>{{provider.prefix}}</td>   
                            <td>{{provider.length}}</td>   
                            <td>{{provider.location_id}}</td>  
                            <td>
...
export default {
    ...
    methods: { 
        ...
        getLists(page = 1, click = false) {
            ...
            axios.get('/api/v1/mk/providers?'+ queryString)
                .then( resp => {  
                    app.preloader = false; 
        ...
        saveForm() { 
            ...
            if ( this.formType ) {
                axios.post('/api/v1/mk/providers', newProvider)
                    .then( resp => {  
                        this.provider = this.providerConst;
                ...
                axios.patch('/api/v1/mk/providers/' + newProvider.id, newProvider)
                    .then( resp => { 
        ...
        deleteEntry(id, index) {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                axios.delete('/api/v1/mk/providers/' + id)
                    .then( resp => {
        ...
        deleteSelected() { 
            ...
            if (confirm(app.$store.state.confirmDel)) {
                ...
                axios.delete('/api/v1/mk/providers/' + selectedItem)
                    .then( resp => {
