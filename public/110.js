...
Component.options.__file = "resources\\assets\\js\\admin\\views\\mk\\providers\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1a6f9698", Component.options)
  } else {
    hotAPI.reload("data-v-1a6f9698", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getLists: function getLists() {
            ...
            axios.get('/api/v1/mk/providers?' + queryString).then(function (resp) {
                app.preloader = false;
        ...
        saveForm: function saveForm() {
            ...
            if (this.formType) {
                axios.post('/api/v1/mk/providers', newProvider).then(function (resp) {
                ...
                axios.patch('/api/v1/mk/providers/' + newProvider.id, newProvider).then(function (resp) {
        ...
        deleteEntry: function deleteEntry(id, index) {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                axios.delete('/api/v1/mk/providers/' + id).then(function (resp) {
        ...
        deleteSelected: function deleteSelected() {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                ...
                axios.delete('/api/v1/mk/providers/' + selectedItem).then(function (resp) {
                          ...
                          ? _c(
                              ...
                              [
                                _c("input", {
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.provider.length,
                                      expression: "provider.length"
                                    }
                                  ],
                                  staticClass: "form-control outline",
                                  attrs: {
                                  ...
                                  domProps: { value: _vm.provider.length },
                                  on: {
                                    input: function($event) {
                                      if ($event.target.composing) {
                                        return
                          ...
                          [
                            _c("date-picker", {
                              ...
                              model: {
                                ...
                                callback: function($$v) {
                                  _vm.$set(_vm.providerSearch, "date_from", $$v)
                                },
            ...
            [
              ...
              _vm._l(_vm.providers.data, function(provider, index) {
                return _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(provider.length))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(provider.location_id))]),
                  _vm._v(" "),
                  _c("td", [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1a6f9698", module.exports)
  }
}
