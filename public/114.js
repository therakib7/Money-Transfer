...
Component.options.__file = "resources\\assets\\js\\admin\\views\\geo\\country-stages\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-46fc3ec7", Component.options)
  } else {
    hotAPI.reload("data-v-46fc3ec7", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        select: function select() {
            this.selected = [];
            if (!this.selectAll) {
                for (var key in this.countrystages.data) {
        ...
        getLists: function getLists() {
            ...
            axios.get('/api/v1/geo/country-stages?' + queryString).then(function (resp) {
                app.preloader = false;
        ...
        saveForm: function saveForm() {
            ...
            if (this.formType) {
                axios.post('/api/v1/geo/country-stages', newPackage).then(function (resp) {
                    _this.countrystage = _this.countrystageConst;
                ...
                axios.patch('/api/v1/geo/country-stages/' + newPackage.id, newPackage).then(function (resp) {
        ...
        editForm: function editForm(countrystage) {
            this.formType = false;
        ...
        deleteEntry: function deleteEntry(id, index) {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                axios.delete('/api/v1/geo/country-stages/' + id).then(function (resp) {
        ...
        deleteSelected: function deleteSelected() {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                ...
                axios.delete('/api/v1/geo/country-stages/' + selectedItem).then(function (resp) {
  ...
  return _c("div", { staticClass: "component" }, [
    ...
    _c("div", { staticClass: "component-body" }, [
                    ...
                    _c("div", { staticClass: "modal-body" }, [
                      _c("div", { staticClass: "form-row" }, [
                        _c(
                          ...
                          [
                            ...
                            _c("multiselect", {
                              ...
                              model: {
                                value: _vm.countrystage.country_id,
                                callback: function($$v) {
                                  _vm.$set(_vm.countrystage, "country_id", $$v)
                                },
                                expression: "countrystage.country_id"
                              }
                            })
                          ],
                          1
                        ...
                        _c(
                          ...
                          _vm._l(_vm.countrystage.countrystages, function(
                            countrystage,
                            key
                          ) {
                                ...
                                _c(
                                  ...
                                  [
                                    _c("input", {
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: countrystage.name,
                                          expression: "countrystage.name"
                                        }
                                      ],
                                      ...
                                      domProps: { value: countrystage.name },
                                      on: {
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: countrystage.native_name,
                                          expression: "countrystage.native_name"
                                        }
                                      ],
                                      staticClass: "form-control outline",
                                      attrs: {
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.countrystageSearch.status,
                                  expression: "countrystageSearch.status"
                                }
                              ],
                              staticClass: "form-control",
                        ...
                        _c(
                          ...
                          [
                            _c("date-picker", {
                              ...
                              model: {
                                value: _vm.countrystageSearch.date_from,
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.countrystageSearch,
                                    "date_from",
                                ...
                                expression: "countrystageSearch.date_from"
                              }
                            })
                          ],
                          1
                        ...
                        _c(
                          ...
                          [
                            _c("date-picker", {
                              ...
                              model: {
                                value: _vm.countrystageSearch.date_to,
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.countrystageSearch,
                                    "date_to",
                                ...
                                expression: "countrystageSearch.date_to"
                              }
                            })
                          ],
                          1
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.countrystageSearch.order_by,
                                  expression: "countrystageSearch.order_by"
                                }
                              ],
                              staticClass: "form-control",
          ...
          _c(
            ...
            [
              _vm.preloader
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm._l(_vm.countrystages.data, function(countrystage, index) {
                return _c("tr", [
                  _c("td", [
                    _c("input", {
                      directives: [
                      ...
                      attrs: {
                        type: "checkbox",
                        id: "checkbox-id-" + countrystage.id
                      },
                      domProps: {
                        value: countrystage.id,
                        checked: Array.isArray(_vm.selected)
                          ? _vm._i(_vm.selected, countrystage.id) > -1
                          : _vm.selected
                      },
                      on: {
                        change: function($event) {
                  ...
                  _c("td", [
                    _c(
                      "label",
                      { attrs: { for: "checkbox-id-" + countrystage.id } },
                      [
                        _vm._v(
                          "\n                        " +
                            _vm._s(countrystage.name)
                        )
                      ]
                    )
                  ]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(countrystage.native_name))]),
                  _vm._v(" "),
                  _c(
                    "td",
                    [
                      _vm._l(countrystage.countrystages, function(
                        value,
                        index
                      ) {
                        return [
                          ...
                          _c(
                            "a",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  _vm.deleteEntry(countrystage.id, index)
                                }
                              }
                            },
                            [
      ...
      _c(
        ...
        [
          _c("pagination", {
            attrs: { data: _vm.countrystages, limit: 2 },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-46fc3ec7", module.exports)
  }
}
