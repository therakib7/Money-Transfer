...
Component.options.__file = "resources\\assets\\js\\admin\\views\\mk\\generated-numbers\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b97cf0c4", Component.options)
  } else {
    hotAPI.reload("data-v-b97cf0c4", Component.options)
  }
    ...
    methods: {
        ...
        saveForm: function saveForm() {
            ...
            if (this.formType) {
                ...
                for (var i = 1; i <= 500; i++) {
                    axios.post('/api/v1/mk/generated-numbers', app.generated_number_new).then(function (resp) {
                ...
                axios.patch('/api/v1/mk/generated-numbers/' + editService.id, editService).then(function (resp) {
        ...
        downloadForm: function downloadForm() {
            ...
            axios.post('/api/v1/mk/download-numbers', app.download_generated_number).then(function (resp) {
                app.$store.commit('submitMsg', 'add');
            }).catch(function (resp) {
                app.$store.commit('errorMessages', resp);
            });
                      ...
                      _c("div", { staticClass: "form-row" }, [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("small", [_vm._v("Give value 10000, 20000 etc")])
                          ]
                        )
                      ])
                    ]),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("multiselect", {
                              ...
                              model: {
                                value:
                                  _vm.download_generated_number.provider_id,
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.download_generated_number,
                                    "provider_id",
                                    $$v
                                  )
                                },
                                expression:
                                  "download_generated_number.provider_id"
                              }
                            }),
                            _vm._v(" "),
                            _vm.download_generated_number.provider_id
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.download_generated_number.from,
                                  expression: "download_generated_number.from"
                                }
                              ],
                              staticClass: "form-control outline",
                              attrs: {
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.download_generated_number.to,
                                  expression: "download_generated_number.to"
                                }
                              ],
                              staticClass: "form-control outline",
                              attrs: {
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("multiselect", {
                              ...
                              model: {
                                value: _vm.generated_numberSearch.provider_id,
                                callback: function($$v) {
                                  _vm.$set(
                                ...
                                expression: "generated_numberSearch.provider_id"
                              }
                            })
                          ],
                          1
            ...
            [
              ...
              _vm._l(_vm.generated_numbers.data, function(
                ...
                return _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(generated_number.id))]),
                  _vm._v(" "),
                  _c("td", [
                    _c(
                      "label",
                  ...
                  _c("td", [
                    _vm._v(
                      _vm._s(generated_number.prefix + generated_number.number)
                    )
                  ]),
                  _vm._v(" "),
                  _c("td", [
      ...
      _c(
        ...
        [
          _c("pagination-simple", {
            attrs: { data: _vm.generated_numbers },
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        "h5",
        { staticClass: "modal-title", attrs: { id: "ModalLongTitle" } },
        [_vm._v("  Update Generated Number")]
      ),
      _vm._v(" "),
      _c(
        "button",
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        "h5",
        { staticClass: "modal-title", attrs: { id: "ModalLongTitle" } },
        [_vm._v(" Download Generated Number")]
      ),
      _vm._v(" "),
      _c(
        "button",
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("i", { staticClass: "dicon-search" }),
        _vm._v(" "),
        _c("span", { staticClass: "d-none d-sm-inline" }, [_vm._v("Download")])
      ]
    )
  },
  function() {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b97cf0c4", module.exports)
  }
}
