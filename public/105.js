...
Component.options.__file = "resources\\assets\\js\\admin\\views\\mt\\help\\help-cats\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-61a2512f", Component.options)
  } else {
    hotAPI.reload("data-v-61a2512f", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getLists: function getLists() {
            ...
            queryString += '&role=1';
            axios.get('/api/v1/mt/taxonomies/help-category?' + queryString).then(function (resp) {
                app.preloader = false;
        ...
        saveForm: function saveForm() {
            ...
            if (this.formType) {
                axios.post('/api/v1/mt/taxonomies', newTaxonomy).then(function (resp) {
                ...
                axios.patch('/api/v1/mt/taxonomies/' + newTaxonomy.id, newTaxonomy).then(function (resp) {
        ...
        deleteEntry: function deleteEntry(id, index) {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                axios.delete('/api/v1/mt/taxonomies/' + id).then(function (resp) {
        ...
        deleteSelected: function deleteSelected() {
            ...
            if (confirm(app.$store.state.confirmDel)) {
                ...
                axios.delete('/api/v1/mt/taxonomies/' + selectedItem).then(function (resp) {
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("multiselect", {
                              ...
                              model: {
                                value: _vm.taxonomy.roles,
                                callback: function($$v) {
                                  _vm.$set(_vm.taxonomy, "roles", $$v)
                                },
                                expression: "taxonomy.roles"
                              }
                            })
                          ],
                          1
            ...
            [
              ...
              _vm._l(_vm.taxonomies.data, function(taxonomy, index) {
                return _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(taxonomy.slug))]),
                  _vm._v(" "),
                  _c(
                    "td",
                    { staticClass: "taxonomies" },
                    [
                      taxonomy.roles.length
                        ? _vm._l(taxonomy.roles, function(role) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-61a2512f", module.exports)
  }
}
