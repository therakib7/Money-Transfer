...
Component.options.__file = "resources\\assets\\js\\admin\\views\\media\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-970dcb20", Component.options)
  } else {
    hotAPI.reload("data-v-970dcb20", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_dropzone__ = __webpack_require__(313);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_dropzone_dist_vue2Dropzone_min_css__ = __webpack_require__(314);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        onSelectMultipleImage: function onSelectMultipleImage(id) {
            var index = this.selectedFiles.findIndex(function (t) {
                return t == id;
            });
            if (index >= 0) {
        ...
        loadAllMedia: function loadAllMedia() {
            this.selectedFiles = [];
            var app = this;
            axios.get('/api/v1/media').then(function (resp) {
                app.dataImages = resp.data;
            }).catch(function (resp) {
                app.$store.commit('errorMessages', resp);
            });
        },
        deleteSeleted: function deleteSeleted() {
            var app = this;
            ...
            if (confirm(app.$store.state.confirmDel)) {
                ...
                axios.delete('/api/v1/media/' + selectedItem).then(function (resp) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "component" }, [
    ...
    _c(
      "div",
      {
        staticClass: "component-body bg-white",
      ...
      [
        _c("div", { staticClass: "tab-area" }, [
          ...
          _c(
            "div",
            { staticClass: "tab-content", attrs: { id: "mediaTabContent" } },
            [
              _c(
                "div",
                {
                        ...
                        _c(
                          ...
                          [
                            _c("img", {
                              ...
                              on: {
                                click: function($event) {
                                  _vm.onSelectMultipleImage(img.id)
                                }
                              }
                            })
                          ]
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "component-heading clearfix" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-970dcb20", module.exports)
  }
}
